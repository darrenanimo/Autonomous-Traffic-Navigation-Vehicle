...
if __name__=='__main__':
    ...
    while True:
        try:
            ...
            hlines = cv.HoughLines(canny_edges, 1, np.pi / 180, 150, None, 0, 0)
            ...
            if hlines is not None:
                ...
                # left 0-1, middle ~3 or ~0, right 1-2
                GPIO.output(red_led, GPIO.LOW)
                GPIO.output(green_led, GPIO.LOW)
                GPIO.output(blue_led, GPIO.LOW)
                
                if (average < 1 and average > 0.3):
                    GPIO.output(red_led, GPIO.HIGH)
                
                elif (average > 2.7 or average < 0.3):
            ...
            cv.imshow('GaussianBlur', gauss_image)
            cv.imshow('CannyEdges', canny_edges)
            cv.imshow('Hough Line Transform', c_canny_edges)
